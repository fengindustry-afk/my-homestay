...
const TABS: { key: TabKey; label: string; description: string }[] = [
  ...
  { key: "rooms", label: "Homestays", description: "Edit homestay details and photos" },
        ...
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative flex items-center gap-2 rounded-full px-3 py-1.5 transition ${isActive
